...
class TextSample:
    def __init__(self, text, author):
        self.raw_text = text
        self.author = author
        def raw_text (self, get_average_sentence_length):
            self.get_average_sentence_length = get_average_sentence_length
    
class AuthorName(TextSample):
    def get_name(self):
        return self.author
...
class AuthorName(TextSample):
    def __init__(author):
        for name in author
        return name
        name = [murderer_sample "The Murderer's note", lily_sample = "Luly Trebuchet Note", myrtle_sample "Mytle Beech Note", gregg_sample "Gregg T Fishy Note"]
